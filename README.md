...
и открыть [localhost:4174](http://localhost:4174). Или просто открыть `docs/ru/skills/index.html` двойным щелчком — работает и так.

Публикация — обычный push в `main`: [`pages.yml`](.github/workflows/pages.yml) сам раскатывает папку `docs` на GitHub Pages.
